...
class Day1: Day {
	...
	private fun subQuestion1(lineList: MutableList<Int>): Int {
		return lineList.sum()
	}
	...
	override fun show() {
		...
		bufferedReader.useLines { lines -> lines.forEach { lineList.add(it.toInt()) } }

		subQuestion1(mutableListOf(+1, -2, +3, +1)) `should equal` (3)
